...
describe('when displaying the edit roles Review request view', () => {
  ...
  beforeEach(() => {
    ...
    getConfirmEditRolesRequest = require('../../../../src/app/requestService/confirmEditRolesRequest').get;
  });
  ...
  it('then it should return the `confirmEditRolesRequest` view', async () => {
    ...
    expect(res.render.mock.calls[0][0]).toBe('requestService/views/confirmEditRolesRequest');
  });
