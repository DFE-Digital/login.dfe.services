...
const model = {
  ...
  approverEmail: '',
  approverName:'',
  dataValues : {id: 'request1', actioned_by: 'user1', actioned_at: null,actioned_reason:'Approved', createdAt: new Date(),organisation_id:'org1', reason:'',role_ids: 'role1', service_id: 'service1', status: 1, updatedAt: new Date(),user_id:'endUser1'},
  endUsersEmail: 'b@b.gov.uk', 
  endUsersFamilyName: 'b', 
  endUsersGvenName:'b',
  isNewRecord: false,
