...
describe('When reviewing a sub-service request for rejecting', () => {
  ...
  beforeEach(() => {
    req = mockRequest({
      ...
      model : {
        ...
        approverEmail: '',
        approverName:'',
        dataValues : {id: 'request1', actioned_by: null, actioned_at: null,actioned_reason:'Pending', createdAt: new Date(),organisation_id:'org1', reason:'reject',role_ids: 'role1', service_id: 'service1', status: 0, updatedAt: new Date(),user_id:'endUser1'},
        endUsersEmail: 'b@b.gov.uk', 
        endUsersFamilyName: 'b', 
        endUsersGvenName:'b',
        isNewRecord: false,
  ...
  it('then it should redirect to reject sub service view', async () => {
    ...
    expect(res.redirect.mock.calls[0][0]).toBe(`/access-requests/subService-requests/${req.params.rid}/rejected`);
