...
const { get: getSelectOrganisationService, post: postSelectOrganisationService } = require('./selectOrganisationService');
...
const users = (csrf) => {
  ...
  router.get('/select-organisation-service', csrf, asyncWrapper(getSelectOrganisationService));
  router.post('/select-organisation-service', csrf, asyncWrapper(postSelectOrganisationService));
