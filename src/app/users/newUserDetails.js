...
const validate = async (req) => {
  ...
  if (!model.email) {
    ...
    // revert the above line back to config.toggles.environmentName === 'pr' && emailPolicy.isBlacklistedEmail(model.email) once the lower environments have been successfully tested.
