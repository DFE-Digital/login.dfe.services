...
where [Name] = 'Academy national non-domestic rates (NNDR) claims')  = 0
    ...
    SET @serviceId = newid();
    INSERT INTO service
        (id, name, description, clientId, clientSecret, apidecret, tokenEndpointAuthMethod, serviceHome, postResetUrl, isExternalService, isMigrated, parentId, isChildService)
    VALUES
